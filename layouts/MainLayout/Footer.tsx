...
export default function Footer() {
  ...
  const hideFooter = router.pathname === '/bridge' || router.pathname === '/import' || router.pathname === '/trade';
  ...
  return (
    <div className={`${isHomePage ? 'mt-0' : 'mt-12'}`}>
      <div className={`container relative mx-auto ${isHomePage ? 'mt-0' : 'mt-[6px]'} flex max-w-[1244px] w-full justify-center px-4 lg:px-8`}>
